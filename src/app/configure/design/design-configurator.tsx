...
const DesignConfigurator = ({
  ...
  return (
    <div className="relative mt-20 mb-20 pb-20 grid grid-cols-1 lg:grid-cols-3">
      <div
        ref={containerRef}
                  ...
                  <div className="mt-3 flex items-center space-x-3">
                    {COLORS.map((color) => (
                      <Radio
                        key={color.label}
                        value={color}
                        className={({ focus: active, checked }) =>
                          cn(
                    ...
                    <DropdownMenuContent>
                      {MODELS.options.map((model) => (
                        <DropdownMenuItem
                          key={model.label}
                          className={cn(
                            "flex text-sm gap-1.5 items-center p-1.5 cursor-default hover:bg-zinc-100",
                            {
                              "bg-zinc-100":
